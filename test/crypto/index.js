...
describe("crypto.js", function () {
  ...
  describe("#getBytes", function () {
    ...
    it("should return Buffer of simply transaction and buffer must be 202 length", function () {
      var transaction = {
        ...
        amount: 1000,
        fee: 2000,
        recipientId: "K9whHQbczCtfLHNvWzgocYCVN8Es3bRP8q",
        timestamp: 141738,
        asset: {},
  ...
  describe("#getId", function () {
    ...
    it("should return string id and be equal to 619fd7971db6f317fdee3675c862291c976d072a0a1782410e3a6f5309022491", function () {
      ...
      (id).should.be.type("string").and.equal("71a7f53bfc4b24167c0a7e508a8e5d8abd0a1bcd49ad42d12b5c5a60d37d4844");
    });
  });
  ...
  describe("#getAddress", function () {
    ...
    it("should generate address by publicKey", function () {
      ...
      (address).should.be.equal("K9whHQbczCtfLHNvWzgocYCVN8Es3bRP8q");
    });
    ...
    it("should generate address by publicKey - second test", function () {
      ...
      (address).should.be.ok;
      (address).should.be.type("string");
      (address).should.be.equal("KFt7DBJ7ZhCYAs9oUSPKozAq4g83CeTvd2");
    });
...
describe("different networks", function () {
  ...
  it("validate address on tesnet should be ok", function () {
    skelpy.crypto.setNetworkVersion(0x52);
    skelpy.crypto.getNetworkVersion().should.equal(0x52);
    var validate = skelpy.crypto.validateAddress("a6fpb1BJZq4otWiVsBcuLG1ZGs5WsqqQtH");
    (validate).should.equal(true);
    skelpy.crypto.setNetworkVersion(0x2D);
    skelpy.crypto.getNetworkVersion().should.equal(0x2D);
  });
});

describe("delegate.js", function () {
  var delegate = skelpy.delegate;
  ...
  describe("#createDelegate", function () {
    ...
    describe("returned delegate", function () {
      var keys = skelpy.crypto.getKeys("secret");
      var secondKeys = skelpy.crypto.getKeys("secret 2");
      ...
      it("should be second signed correctly", function () {
        var result = skelpy.crypto.verifySecondSignature(trs, secondKeys.publicKey);
        (result).should.be.ok;
      });
