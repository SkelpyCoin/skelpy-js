...
describe("transaction.js", function () {
  ...
  var transaction = skelpy.transaction;
  ...
  describe("#createTransaction", function () {
    ...
    it("should create transaction without second signature", function () {
      trs = createTransaction("K9whHQbczCtfLHNvWzgocYCVN8Es3bRP8q", 1000, null, "secret");
      (trs).should.be.ok;
    });

    it("should create transaction without second signature from keys", function () {
      var secretKey = skelpy.ECPair.fromSeed("secret");
      secretKey.publicKey = secretKey.getPublicKeyBuffer().toString("hex");

      trs = createTransaction("K9whHQbczCtfLHNvWzgocYCVN8Es3bRP8q", 1000, null, secretKey);
      (trs).should.be.ok;
    });

    it("should create transaction with vendorField", function () {
      trs = createTransaction("K9whHQbczCtfLHNvWzgocYCVN8Es3bRP8q", 1000, "this is a test vendorfield", "secret");
      (trs).should.be.ok;
    });

    it("should create transaction with fee override", function () {
      const feeOverride = 1000000
      trs = createTransaction("K9whHQbczCtfLHNvWzgocYCVN8Es3bRP8q", 1000, null, "secret", undefined, undefined, feeOverride);
      (trs).should.be.ok;
    ...
    it("should fail if transaction with vendorField length > 64", function () {
      ...
      vf=vf+"z";
      trs = createTransaction("K9whHQbczCtfLHNvWzgocYCVN8Es3bRP8q", 1000, vf, "secret");
    ...
    describe("returned transaction", function () {
      ...
      it("should have recipientId as string and to be equal K9whHQbczCtfLHNvWzgocYCVN8Es3bRP8q", function () {
        (trs.recipientId).should.be.type("string").and.equal("K9whHQbczCtfLHNvWzgocYCVN8Es3bRP8q");
      });
      ...
      it("should be signed correctly", function () {
        var result = skelpy.crypto.verify(trs);
        result.should.equal(true);
      });

      it("should be deserialised correctly", function () {
        var deserialisedTx = skelpy.crypto.fromBytes(skelpy.crypto.getBytes(trs).toString("hex"));
  ...
  describe("createTransaction and try to tamper signature", function(){
    ...
    it("should not validate overflown signatures", function(){
      ...
      var old_transaction = skelpy.transaction.createTransaction('KFwjTTHBJYBNbmuHqSFyHfsYnnvUJRUEP2', 1, null, 'randomstring');
      ...
      */
      ...
      // console.log("TXID " + skelpy.crypto.getId(old_transaction));
      // console.log("VERIFY " + skelpy.crypto.verify(old_transaction));
      // console.log("SIG " + old_transaction.signature + "\n");

      skelpy.crypto.verify(old_transaction).should.equal(true);
      ...
      skelpy.crypto.verify(old_transaction).should.equal(false);
  ...
  describe("#createTransaction with second secret", function () {
    ...
    var keys = skelpy.crypto.getKeys(secondSecret);
    ...
    it("should create transaction without second signature", function () {
      trs = createTransaction("K9whHQbczCtfLHNvWzgocYCVN8Es3bRP8q", 1000, null, "secret", secondSecret);
      (trs).should.be.ok;
    });
    ...
    describe("returned transaction", function () {
      ...
      it("should be second signed correctly", function () {
        var result = skelpy.crypto.verifySecondSignature(trs, keys.publicKey);
        (result).should.equal(true);
      });
